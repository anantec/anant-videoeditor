...
export const Footer = () => {
    ...
    const socialIcons = [
        ...
        { icon: FaInstagram, href: "https://www.instagram.com/sochungausername" },
        { icon: FaLinkedin, href: "https://www.linkedin.com/in/anantdugtal/" },
        { icon: FaXTwitter, href: "https://x.com/pookieanant" },
    ]
